...
export const selectTrendingMovies = (state: RootState) =>
  state.movies.trendingMovies.movies.results;
export const selectTrendingMoviesStatus = (state: RootState) =>
  state.movies.trendingMovies.status;
export const selectTrendingMoviesError = (state: RootState) =>
  state.movies.trendingMovies.error;

// upcoming movies selectors
export const selectUpcomingMovies = (state: RootState) =>
  state.movies.upcomingMovies.movies.results;
export const selectUpcomingMoviesStatus = (state: RootState) =>
  state.movies.upcomingMovies.status;
export const selectUpcomingMoviesError = (state: RootState) =>
  state.movies.upcomingMovies.error;

// top rated movies selectors
export const selectTopRatedMovies = (state: RootState) =>
  state.movies.topRatedMovies.movies.results;
export const selectTopRatedMoviesStatus = (state: RootState) =>
  state.movies.topRatedMovies.status;
export const selectTopRatedMoviesError = (state: RootState) =>
  state.movies.topRatedMovies.error;
